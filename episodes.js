...
// this helps for search by season number
/*
search my name episod.name.includes(get the value of search bar)

*/
// updating the array

function search(search) {
  return getAllEpisodes().forEach((episod) => {
    if (
      episod.name.includes(search) ||
      episod.season === search ||
      episod.number === search
    ) {
      function pushToArray() {
        episodesArray.push(
          ...
          episod.runtime,
          episod.image.medium,
          episod.image.original,
          episod.summary,
          episod._links.self.href
        );
      }
      pushToArray();
    }
...
const sesson1 = getAllEpisodes().forEach((episod) => {
  return episod.season === 1
    ? episodesArray.push(
        episod.id,
        episod.url,
        episod.name,
...
//console.log(sesson1)
 { search, sesson1, getAllEpisodes, getOneEpisode }
